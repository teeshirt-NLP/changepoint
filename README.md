...
This code implements the algorithm described in the [Main Paper](https://github.com/teeshirt-NLP/changepoint/blob/master/Paper.anon.pdf) [1]. The authors use a statistical model to learn word embeddings that optimally differentiate between topics.
...
1) Download [Wikipedia](https://meta.wikimedia.org/wiki/Data_dump_torrents#English_Wikipedia) then extract it using ```bzip2 -dk enwiki-YOURDATE-pages-articles-multistream.xml.bz2```
